    ...
    <div className='grid  grid-cols-3 gap-1 bg-[--tw-color-800] md:bg-[--tw-color-950] text-xs font-bold '>
      {
        buttons.map((button: any, i: number) => (
          ...
          <button
            ...
            className={`${selectedTab === i ? "border-[--tw-primary]" : "border-transparent"} md:border-transparent active:bg-[--tw-color-900] border-b-2 py-3 md:cursor-default md:text-lg`} >{button}</button>
        ))
      }
