    ...
    return (
        ...
        <div className='flex flex-col md:m-6'>
            ...
            <div className='grid md:grid-cols-3 gap-10 mt-3 px-2'>
                ...
                {data?.res1 != null && <TeamFixture data={data?.res1 || null} selectedTab={selectedTab} teamId={id} />}
                {data?.res2 != null && <TeamRoster data={data?.res2 || null} selectedTab={selectedTab} />}
                {data?.res3 != null && <TeamArticles data={data?.res3 || null} selectedTab={selectedTab} />}
