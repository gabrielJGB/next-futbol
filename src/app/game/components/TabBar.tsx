...

      {
        tabs.map((tab: any, i: number) =>{
          return tab.show && (
            ...
            <button
              key={i}
              className={`flex transition-all active:bg-[--tw-color-900] hover:text-white md:px-3 px-4 md:py-3 py-4 border-b-[3px] ${selectedTab === i ? "border-[--tw-primary] " : "border-transparent text-gray-300"} transition-all duration-200`}
