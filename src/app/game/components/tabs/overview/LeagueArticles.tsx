        ...
        <div className='flex flex-col bg-[--tw-color-800] pb-2 rounded-lg divide-y-[1px] p-2 divide-[--tw-color-700]'>
...

            {
                articles.map((article: any, i: number) => (
                    ...
                    <Link key={i} href={`/${article.type === "dStory"?"article":"video"}/${article.id}`} className='flex flex-row gap-2 px-1 py-2 cursor-pointer hover:bg-[--tw-color-700] transition-all'>
